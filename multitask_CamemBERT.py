...
# # Multi-task CamemBERT model for SBD, POS and NER
...
train_df = train_df[train_df['sent_num'] < 2000000]
test_df = test_df[test_df['sent_num'] < 1000000]
...
camembert_tokenizer = transformers.CamembertTokenizer.from_pretrained('camembert-base')


# In[ ]:


camembert_model = transformers.CamembertModel.from_pretrained('camembert-base')
